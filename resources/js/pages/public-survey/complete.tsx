      ...
      <div className="min-h-screen bg-gradient-to-br from-success/10 to-primary/10 flex items-center justify-center p-4">
        <div className="d-card bg-base-100 shadow-2xl max-w-md w-full">
          <div className="d-card-body text-center">
            ...
            <h1 className="d-card-title text-2xl justify-center mb-4">Survey Complete!</h1>
            ...
            {survey.description && (
              <div className="d-alert d-alert-info mb-6">
                <div className="text-sm">{survey.description}</div>
              </div>
            )}
            
            <div className="d-card bg-base-200 shadow-sm mb-6">
            ...
            <button 
              className="d-btn d-btn-primary w-full"
